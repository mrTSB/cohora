...
const BASE_URL = "https://c444-50-175-245-62.ngrok-free.app";
const WS_URL = "wss://c444-50-175-245-62.ngrok-free.app/ws";
...
export async function connectToChat(onMessage: (message: MessageDelivery) => void): Promise<void> {
    if (!userId) {
        throw new Error('User not authenticated');
    }
